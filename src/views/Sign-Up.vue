...
<template>
	<div>
		...
		<a-card :bordered="false" class="card-signup header-solid h-full" :bodyStyle="{paddingTop: 0}">
			<template #title>
				<h5 class="font-semibold text-center">보호자 회원가입</h5>
			</template>
			...
			<p class="font-semibold text-muted text-center">이미 계정이 있으신가요? <router-link to="/sign-in" class="font-bold text-dark">로그인</router-link></p>
		</a-card>
		<!-- / Sign Up Form -->
